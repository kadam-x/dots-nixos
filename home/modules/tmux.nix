{ pkgs, ... }:
{
  programs.tmux = {
    ...
    extraConfig = ''
      ...
      set -g pane-active-border-style "fg=#74b2ff"
      set -g status-style "bg=#1c1c1c,fg=#a0a0a0"
      set -g message-style "fg=#74b2ff,bg=#2a2e3f,align=centre"
      set -g message-command-style "fg=#74b2ff,bg=#2a2e3f,align=centre"
      set -g window-status-activity-style "fg=#f1fa8c,bg=#1c1c1c,none"
      set -g window-status-separator ""
      set -g window-status-style "fg=#a0a0a0,bg=#1c1c1c,none"
      set -g window-status-current-format "#[fg=#a0a0a0,bg=#1c1c1c] #I*: #[fg=#74b2ff,bg=#1c1c1c,bold]#W "
      set -g window-status-format "#[fg=#a0a0a0,bg=#1c1c1c] #I: #[fg=#a0a0a0,bg=#1c1c1c]#W "
      set -g status-left "#[fg=#a0a0a0,bg=#1c1c1c] [#S] "
      set -g status-right "#{?client_prefix,#[fg=#74b2ff],#[fg=#a0a0a0]}[PREFIX] #[fg=#3a3f58]| #[fg=#a0a0a0]#{pane_current_command} "
      set -g mode-style "fg=#74b2ff bg=#2a2e3f bold"
      set -g clock-mode-colour "#74b2ff"
