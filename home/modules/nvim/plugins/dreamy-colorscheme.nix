    ...
    extraPlugins.base16 = {
      ...
      setup = ''
        require("base16-colorscheme").setup({
          base00 = "#011627", base01 = "#091e2f", base02 = "#232e3b",
        ...
        vim.api.nvim_set_hl(0, "Cursor",      { fg = "#011627", bg = "#f94dff" })
        -- Syntax
        ...
        -- Pmenu
        vim.api.nvim_set_hl(0, "Pmenu",    { fg = "#ffffff",  bg = "#091e2f" })
        vim.api.nvim_set_hl(0, "PmenuSel", { fg = "#011627", bg = "#987afb", bold = true })
        -- Spell
        ...
        vim.api.nvim_set_hl(0, "@markup.raw.block", { bg = "#091e2f" })
        vim.api.nvim_set_hl(0, "@markup.raw",       { fg = "#04d1f9", bg = "#091e2f" })
        vim.api.nvim_set_hl(0, "@markup.link.url",  { fg = "#04d1f9", underline = true })
        vim.api.nvim_set_hl(0, "@markup.link",      { fg = "#987afb" })
        -- Barbar active tab
        vim.api.nvim_set_hl(0, "BufferCurrent",            { fg = "#011627", bg = "#987afb", bold = true })
        vim.api.nvim_set_hl(0, "BufferCurrentMod",         { fg = "#011627", bg = "#987afb" })
        vim.api.nvim_set_hl(0, "BufferCurrentSign",        { fg = "#011627", bg = "#987afb" })
        vim.api.nvim_set_hl(0, "BufferDefaultCurrentIcon", { fg = "#011627", bg = "#987afb" })
        -- Barbar visible tabs
        vim.api.nvim_set_hl(0, "BufferVisible",            { fg = "#987afb", bg = "#091e2f" })
        vim.api.nvim_set_hl(0, "BufferVisibleMod",         { fg = "#e58f2a", bg = "#091e2f" })
        vim.api.nvim_set_hl(0, "BufferVisibleSign",        { fg = "#232e3b", bg = "#091e2f" })
        vim.api.nvim_set_hl(0, "BufferDefaultVisibleIcon", { bg = "#091e2f" })
        -- Barbar inactive tabs
        vim.api.nvim_set_hl(0, "BufferInactive",            { fg = "#b7bfce", bg = "#091e2f" })
        vim.api.nvim_set_hl(0, "BufferInactiveMod",         { fg = "#e58f2a", bg = "#091e2f" })
        vim.api.nvim_set_hl(0, "BufferInactiveSign",        { fg = "#232e3b", bg = "#091e2f" })
        vim.api.nvim_set_hl(0, "BufferDefaultInactiveIcon", { bg = "#091e2f" })
        -- Barbar tabline
        vim.api.nvim_set_hl(0, "BufferTabpageFill", { fg = "#091e2f", bg = "#011627" })
        vim.api.nvim_set_hl(0, "BufferTabpages",    { fg = "#987afb", bg = "#011627", bold = true })
        -- Line numbers
        vim.api.nvim_set_hl(0, "LineNrAbove", { fg = "#232e3b", bg = "#091e2f" })
        vim.api.nvim_set_hl(0, "LineNrBelow", { fg = "#232e3b", bg = "#091e2f" })
      '';
    };
  };
}
