{ ... }:
{
  programs.qutebrowser = {
    ...
    settings = {
      ...
      colors.tabs.selected.odd.bg = "#285577";
      ...
      colors.tabs.indicator.stop = "#285577";
      ...
      colors.completion.category.fg = "#285577";
      ...
      colors.completion.item.selected.bg = "#285577";
      colors.completion.item.selected.border.top = "#285577";
      colors.completion.item.selected.border.bottom = "#285577";
      ...
      colors.statusbar.insert.fg = "#285577";
      ...
      colors.statusbar.caret.fg = "#285577";
      colors.statusbar.caret.selection.bg = "#1a1a1a";
      colors.statusbar.caret.selection.fg = "#285577";
      colors.statusbar.progress.bg = "#285577";
      ...
      colors.downloads.stop.bg = "#285577";
