{ ... }:
{
  programs.qutebrowser = {
    ...
    settings = {
      ...
      colors.webpage.bg = "#1f1f23";
      # tabs
      colors.tabs.bar.bg = "#111111";
      colors.tabs.selected.odd.bg = "#3b3b3f";
      colors.tabs.selected.odd.fg = "#ffffe4";
      colors.tabs.selected.even.bg = "#3b3b3f";
      colors.tabs.selected.even.fg = "#ffffe4";
      colors.tabs.odd.bg = "#1f1f23";
      colors.tabs.odd.fg = "#888888";
      colors.tabs.even.bg = "#1f1f23";
      colors.tabs.even.fg = "#888888";
      colors.tabs.pinned.selected.odd.bg = "#aaaaaa";
      colors.tabs.pinned.selected.odd.fg = "#1f1f23";
      colors.tabs.pinned.selected.even.bg = "#aaaaaa";
      colors.tabs.pinned.selected.even.fg = "#1f1f23";
      ...
      colors.tabs.indicator.stop = "#3b3b3f";
      colors.tabs.indicator.error = "#912222";
      # completion
      colors.completion.fg = "#c1c1c1";
      colors.completion.odd.bg = "#1f1f23";
      colors.completion.even.bg = "#111111";
      colors.completion.category.fg = "#3b3b3f";
      colors.completion.category.bg = "#1f1f23";
      colors.completion.category.border.top = "#1f1f23";
      colors.completion.category.border.bottom = "#2a2a2a";
      colors.completion.item.selected.fg = "#1f1f23";
      colors.completion.item.selected.bg = "#3b3b3f";
      colors.completion.item.selected.border.top = "#3b3b3f";
      colors.completion.item.selected.border.bottom = "#3b3b3f";
      colors.completion.item.selected.match.fg = "#1f1f23";
      colors.completion.match.fg = "#ffffff";
      colors.completion.scrollbar.fg = "#444444";
      colors.completion.scrollbar.bg = "#1f1f23";
      # statusbar
      colors.statusbar.normal.bg = "#1f1f23";
      colors.statusbar.normal.fg = "#888888";
      colors.statusbar.insert.bg = "#1f1f23";
      colors.statusbar.insert.fg = "#3b3b3f";
      colors.statusbar.passthrough.bg = "#1f1f23";
      colors.statusbar.passthrough.fg = "#aaaaaa";
      colors.statusbar.command.bg = "#1f1f23";
      colors.statusbar.command.fg = "#c1c1c1";
      colors.statusbar.caret.bg = "#1f1f23";
      colors.statusbar.caret.fg = "#3b3b3f";
      colors.statusbar.caret.selection.bg = "#1a1a1a";
      colors.statusbar.caret.selection.fg = "#3b3b3f";
      colors.statusbar.progress.bg = "#3b3b3f";
      ...
      # downloads
      colors.downloads.bar.bg = "#1f1f23";
      colors.downloads.start.bg = "#1a1a1a";
      colors.downloads.start.fg = "#c1c1c1";
      colors.downloads.stop.bg = "#3b3b3f";
      colors.downloads.stop.fg = "#1f1f23";
      ...
      colors.prompts.selected.bg = "#3b3b3f";
      colors.prompts.selected.fg = "#1f1f23";
      # context menu
      colors.contextmenu.menu.bg = "#111111";
      colors.contextmenu.menu.fg = "#c1c1c1";
      colors.contextmenu.selected.bg = "#3b3b3f";
      colors.contextmenu.selected.fg = "#1f1f23";
